...
public class TaraturDriver implements IDriver {
	...
	public NewsEntity parseNewsPerCategory(String newsURL) {
		...
		try {
			...
			newsElements.select("a, img, script, fb, div[class=slicni_div], div[class=fb-like], div, span, article, header, ul, il, h3[class=sd-title, footer]").remove();
