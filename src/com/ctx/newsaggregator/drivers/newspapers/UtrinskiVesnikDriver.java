...
public class UtrinskiVesnikDriver implements IDriver {
	...
	public List<String> parseCategory(String categoryName, String categoryURL) {
		...
		try {
			...
			Elements links = doc.getElementsByClass("WB_UTRINSKIVESNIK_MoreLink");
			...
			if (links != null && links.size() > 0) {
				...
				for (Element element : links) {
					...
					newsLink = newsLink.substring(newsLink.indexOf("?"));
	...
	public NewsEntity parseNewsPerCategory(String newsURL) {
		...
		try {
			...
			Elements newsElements = doc.getElementsByClass("WB_UTRINSKIVESNIK_Normal");
	...
	public List<CategoryEntity> parseHomeForCategoryLinks(String baseURL) {
		...
		try {
			...
			if (doc != null) {
				...
				Elements categoryElements = doc.select("table[class=ime-rubrika]").select("a");
